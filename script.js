...
const translations = {
    ar: {
        ...
        faqPageDesc: "إجابات على الأسئلة الأكثر شيوعاً في تعلم بايثون",
        faqContactTitle: "هل لديك سؤال آخر؟",
        faqContactDesc: "إذا كان لديك سؤال لم تجد إجابته في الأسئلة الشائعة، يمكنك طرحه هنا وسأرد عليك عبر واتساب",
        faqContactPlaceholder: "اكتب سؤالك هنا...",
        faqContactButton: "إرسال السؤال",
        level1Title: "أنواع البيانات والإدخال",
        level2Title: "المتغيرات والتعبيرات",
        level3Title: "المعاملات",
        level4Title: "التحكم بالتدفق",
        level5Title: "الحلقات",
        level6Title: "القوائم والمجموعات",
        level7Title: "المجموعات والقواميس",
        level8Title: "الدوال والاستثناءات",
        level9Title: "الملفات و OOP",
        level10Title: "واجهات المستخدم الرسومية (GUI)"
    },
    en: {
        appName: "Zaid.python",
        navHome: "Home",
        ...
        faqPageDesc: "Answers to the most common questions about learning Python",
        faqContactTitle: "Have another question?",
        faqContactDesc: "If you have a question not listed above, ask me here and I'll respond via WhatsApp",
        faqContactPlaceholder: "Type your question here...",
        faqContactButton: "Send Question",
        level1Title: "Data Types & Input",
        level2Title: "Variables & Expressions",
        level3Title: "Operators",
        level4Title: "Control Flow",
        level5Title: "Loops",
        level6Title: "Lists & Tuples",
        level7Title: "Sets & Dictionaries",
        level8Title: "Functions & Exceptions",
        level9Title: "Files & OOP",
        level10Title: "Graphical User Interfaces (GUI)"
    }
};
...
const faqQuestions = {
    1: [
        {
            question: "ما هي أنواع البيانات الأساسية في بايثون؟",
            answer: `أنواع البيانات الأساسية في بايثون تشمل:
1. الأعداد الصحيحة (int): مثل 5, 10, -3
2. الأعداد العشرية (float): مثل 3.14, 2.5, -0.5
3. السلاسل النصية(الكلمات) (str): مثل "مرحباً", 'بايثون'
...
يمكنك التحقق من نوع أي متغير باستخدام دالة type():
<code>print(type(5))      # <class 'int'>
print(type(3.14))    # <class 'float'>
print(type("Hello")) # <class 'str'></code>`
        },
        {
            question: "كيف يمكنني أخذ مدخلات من المستخدم؟",
            answer: `يمكنك استخدام الدالة input() لأخذ مدخلات من المستخدم:
<code>name = input("أدخل اسمك: ")
user_age = int(input("أدخل عمرك: "))  # تحويل النص إلى عدد صحيح

print(f"مرحباً، {name}! عمرك {user_age} سنة.")</code>`
        },
        {
            question: "كيف يمكنني تحويل بين أنواع البيانات؟",
            answer: `يمكنك التحويل بين أنواع البيانات باستخدام دوال التحويل:
1. int(): تحويل إلى عدد صحيح
2. float(): تحويل إلى عدد عشري
3. str(): تحويل إلى سلسلة نصية
4. bool(): تحويل إلى قيمة منطقية

أمثلة:
<code>num_str = "123"
num_int = int(num_str)  # تحويل النص إلى عدد صحيح

float_str = "3.14"
float_val = float(float_str)  # تحويل النص إلى عدد عشري

int_to_str = str(42)  # تحويل العدد إلى نص</code>`
        }
    ],
    2: [
        {
            question: "ما هو المتغير في بايثون؟",
            answer: `المتغير هو اسم نطلقه على مكان في الذاكرة لتخزين البيانات. تخيله كصندوق يمكنك وضع أي شيء بداخله.

طريقة تعريف المتغير:
<code>x = 10
greeting = "مرحباً، بايثون!"
my_variable = "هذا متغير."</code>

قواعد تسمية المتغيرات:
- يمكن أن يحتوي على حروف، أرقام، وشرطة سفلية
- لا يمكن أن يبدأ برقم
- حساس لحالة الأحرف (Name ≠ name)
- لا يمكن استخدام الكلمات المفتاحية مثل if, for, while
- يفضل استخدام أسماء وصفية مثل user_name بدلاً من un`
        },
        {
            question: "ما هي التعبيرات في بايثون؟",
            answer: `التعبيرات (Expressions) هي مزيج من المتغيرات والقيم والمعاملات التي يتم تقييمها للحصول على قيمة واحدة.
...
print(f"النتيجة: {div_result}")  # 3.75</code>`
        }
    ],
    3: [
        {
            question: "ما هي أنواع المعاملات في بايثون؟",
            answer: `أنواع المعاملات:
1. معاملات حسابية: +, -, *, /, %, //, **
2. معاملات مقارنة: ==, !=, >, <, >=, <=
3. معاملات منطقية: and, or, not
4. معاملات هوية: is, is not
5. معاملات عضوية: in, not in
...
print(f"NOT is_logged_in: {not is_logged_in}") # False</code>`
        }
    ],
    4: [
        {
            question: "كيف أستخدم عبارات if في بايثون؟",
            answer: `يمكنك استخدام عبارات if, elif, else لاتخاذ قرارات في الكود:
...
if score >= 90:
    ...
    print("التقدير: مقبول")</code>`
        }
    ],
    5: [
        {
            question: "ما الفرق بين حلقة for وحلقة while؟",
            answer: `1. حلقة for: تستخدم للتكرار على سلسلة من العناصر (قائمة، مجموعة، سلسلة نصية، إلخ)
<code>fruits = ["تفاح", "موز", "كرز"]
for fruit in fruits:
    print(f"أحب {fruit}")

# مع دالة range()
for number in range(5): 
    print(f"الرقم: {number}")</code>

2. حلقة while: تستمر في التكرار طالما أن الشرط صحيح
<code>count = 0
while count < 5:
    print(f"العدد: {count}")
    count += 1  # زيادة العدد بمقدار 1 في كل تكرار</code>`
        }
    ],
    6: [
        {
            question: "ما الفرق بين القوائم (Lists) والمجموعات (Tuples)؟",
            answer: `الاختلافات الرئيسية:
1. القوائم (Lists):
   - قابلة للتغيير (mutable)
   - يمكن إضافة/حذف/تعديل العناصر
   - تستخدم الأقواس المربعة []

2. المجموعات (Tuples):
   - غير قابلة للتغيير (immutable)
   - لا يمكن تعديلها بعد الإنشاء
   - تستخدم الأقواس العادية ()
...
print(my_tuple) # ('تفاح', 'موز', 'كرز')</code>`
        }
    ],
    7: [
        {
            question: "ما هي القواميس (Dictionaries) في بايثون؟",
            answer: `القواميس هي هياكل بيانات تخزن البيانات كأزواج مفتاح-قيمة (key-value pairs). المفاتيح يجب أن تكون فريدة وغير قابلة للتغيير.
...
الوصول إلى القيم:
<code>print(user_profile["username"]) # الوصول إلى قيمة المفتاح
user_profile["age"] = 26        # تعديل قيمة
user_profile["location"] = "عمان" # إضافة زوج مفتاح-قيمة جديد</code>`
        }
    ],
    8: [
        {
            question: "كيف أُعرف دالة في بايثون؟",
            answer: `يمكنك تعريف دوال باستخدام الكلمة المفتاحية def:
...
الدوال يمكن أن تعيد قيم باستخدام return:
<code>def add_numbers(a, b):
    """تجمع رقمين وتعيد النتيجة"""
    return a + b

result = add_numbers(5, 7)
print(f"النتيجة: {result}") # 12</code>`
        }
    ],
    9: [
        {
            question: "كيف أتعامل مع الملفات في بايثون؟",
            answer: `يمكنك استخدام with open() للتعامل مع الملفات بأمان:
...
with open("testfile.txt", "a") as file:
    file.write("\\nسطر جديد تمت إضافته.")</code>`
        }
    ],
    10: [
        {
            question: "كيف أنشئ واجهة مستخدم رسومية باستخدام Tkinter؟",
            answer: `مثال بسيط لإنشاء نافذة باستخدام Tkinter:
            ...
            <div class="container mx-auto text-center mt-20">
                ...
                <div class="bg-[#1f2833] p-8 md:p-12 rounded-3xl shadow-xl mb-12">
                    ...
                    <div class="flex flex-col md:flex-row justify-center gap-4">
                        ...
                        <a href="https://wa.me/962799569573?text=مرحباً%20زيد،%20أحتاج%20مساعدة%20في%20بايثون" target="_blank" class="bg-whatsapp text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 social-button">
...
print(f"a % b = {a % b}")   # 1 (باقي القسمة)
print(f"a // b = {a // b}") # 3 (قسمة صحيحة)
print(f"a ** b = {a ** b}") # 50625 (أس)`
                },
                {
                    title: t.exampleTitle + " 2",
...
print(fruits[-1]) # كرز (آخر عنصر)`
            ...
            // تم حذف الأسئلة من المستوى 6 كما طلبتم
            quiz: null
        },
        7: {
            title: t.level7,
...
print(values) # dict_values(['Ford', 'Mustang', 1964])`
            ...
            // تم حذف الأسئلة من المستوى 7 كما طلبتم
            quiz: null
        },
        8: {
            title: t.level8,
    ...
    return `
        <div class="min-h-screen p-4">
            <div class="container mx-auto mt-20 max-w-4xl">
                ...
                <!-- Resources Section (Added for all levels) -->
                <div class="bg-[#1f2833] p-8 md:p-12 rounded-3xl shadow-xl mb-12 ${langClass}">
                    <h3 class="text-2xl font-bold text-yellow-400 mb-4">${t.resourcesTitle}</h3>
                    <p class="text-lg text-gray-300 leading-relaxed mb-6">${t.resourceDesc}</p>
                    
                    <div class="grid grid-cols-1 gap-4">
                        <!-- رابط w3schools الجديد للمستوى الحالي -->
                        <div class="resource-item">
                            <div class="flex items-center">
                                <i class="fas fa-globe resource-icon"></i>
                                <div>
                                    <h4 class="text-lg font-bold text-white">W3Schools: ${levelData.title}</h4>
                                    <a href="${getW3SchoolLink(level)}" target="_blank" class="resource-link">
                                        <i class="fas fa-link mr-1"></i> ${t.resourceLink}
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="resource-item">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="text-lg font-bold text-white">قناة بايثون بالعربي على اليوتيوب</h4>
                                    <a href="https://youtu.be/ij6qQQlGKtE?si=ZK2jwSrXsjWY4Sau" target="_blank" class="resource-link">
                                        <i class="fas fa-link mr-1"></i> ${t.resourceLink}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="resource-item">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="text-lg font-bold text-white">كتاب تعلم بايثون للمبتدئين</h4>
                                    <a href="https://python-guide.readthedocs.io/" target="_blank" class="resource-link">
                                        <i class="fas fa-link mr-1"></i> ${t.resourceLink}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="resource-item">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h4 class="text-lg font-bold text-white">تمارين تفاعلية على بايثون</h4>
                                    <a href="https://nouvil.net/problem-solving/python-problem-solving/" target="_blank" class="resource-link">
                                        <i class="fas fa-link mr-1"></i> ${t.resourceLink}
                                    </a>
                                </div>
                            </div>
                ...
                <!-- Quiz Section (Hidden for level 2,6,7) -->
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                            ${levelData.quiz.options.map((option, index) => `
                                <div class="quiz-option" onclick="handleOptionClick(this, '${option}', ${level})">
                        ...
                        <!-- تم إزالة زر التحقق من الإجابة -->
                    </div>
                </div>
                ` : ''}
                
                <!-- Next Level Button -->
                ${(level === 2 || selectedOption) ? `
...
// دالة لإنشاء روابط w3schools حسب المستوى
function getW3SchoolLink(level) {
    const links = {
    ...
    return links[level] || "https://www.w3schools.com/python/";
}
...
function handleOptionClick(element, option, level) {
    ...
    if (option === correctAnswer) {
        ...
        showFeedback(translations[currentLang].quizCorrect, 'green', 'fas fa-hat-cowboy');
    } else {
        element.classList.add('incorrect');
        showFeedback(translations[currentLang].quizIncorrect, 'red', 'fas fa-times-circle');
        
        // إظهار الإجابة الصحيحة
        document.querySelectorAll('.quiz-option').forEach(el => {
            const optionText = el.querySelector('span').textContent;
...
// دالة لعرض الرسالة التفاعلية
function showFeedback(message, color, iconClass) {
    // إنصراف الرسالة القديمة إذا كانت موجودة
    const existingFeedback = document.getElementById('custom-feedback');
    if (existingFeedback) existingFeedback.remove();
    
    // إنشاء عنصر الرسالة الجديدة
    const feedback = document.createElement('div');
    feedback.id = 'custom-feedback';
    feedback.className = `fixed bottom-6 ${currentLang === 'ar' ? 'left-6' : 'right-6'} z-50`;
    feedback.innerHTML = `
        <div class="bg-${color}-500 text-white px-6 py-4 rounded-xl shadow-lg flex items-center animate-fadeIn">
...
function faqPage() {
    ...
    return `
        <div class="faq-page-container">
            <h1 class="faq-page-title floating-element">${t.faqPageTitle}</h1>
            <p class="faq-page-description">${t.faqPageDesc}</p>
            
            ${Object.entries(faqQuestions).map(([level, questions]) => `
                <div class="faq-level">
                    <h2 class="faq-level-title">${t[`level${level}Title`]}</h2>
                    <div class="faq-questions">
                        ${questions.map((q, index) => `
                            <div class="faq-question">
                                <div class="faq-question-header">
                                    <span class="faq-question-number">${index + 1}</span>
                                    <h3 class="faq-question-title">${q.question}</h3>
                                </div>
            ...
            <div class="contact-form">
                <h2>${t.faqContactTitle}</h2>
                <p>${t.faqContactDesc}</p>
                <form id="question-form" onsubmit="sendQuestion(event)">
                    <div class="form-group">
                        <label for="question">${t.faqContactPlaceholder}</label>
                        <textarea id="question" name="question" placeholder="${t.faqContactPlaceholder}" required></textarea>
                    </div>
                    <button type="submit" class="submit-btn">
                        <i class="fas fa-paper-plane mr-2"></i>${t.faqContactButton}
                    </button>
                </form>
            </div>
            </div>
...
// Send question via WhatsApp - FIXED VERSION
function sendQuestion(event) {
    ...
    const message = `مرحباً زيد، بتقدر تجاوبني على هذا سؤال؟\n\n${question}\n\nشكراً جزيلاً، زيد`;
    const encodedMessage = encodeURIComponent(message);
    
    // Create WhatsApp URL
    const whatsappUrl = `https://wa.me/962799569573?text=${encodedMessage}`;
    ...
    alert('تم إرسال سؤالك بنجاح! سأرد عليك قريباً عبر واتساب.');
}
...
// ... (الكود الحالي يبقى كما هو حتى نهاية تعريف المتغيرات والدوال)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    changePage(initialPage, null, false);
...
// Handle routing and navigation
function changePage(page, data = null, addToHistory = true) {
    currentPage = page;
    currentPageData = data;
    selectedOption = null; // Reset selected option
...
// ... (بقية الكود يبقى كما هو)// ... (الكود الحالي كاملاً يبقى كما هو)

// إضافة دالة لعرض الـ Popup
function showDesktopPopup() {
    // التحقق مما إذا كان المستخدم قد أغلق الـ Popup مسبقاً
    if (!localStorage.getItem('desktopPopupClosed')) {
        setTimeout(function() {
            document.getElementById('desktopPopup').style.display = 'flex';
        }, 3000); // عرض الـ Popup بعد 3 ثواني من تحميل الصفحة
    }
}

// إضافة دالة لإغلاق الـ Popup
function closePopup() {
    document.getElementById('desktopPopup').style.display = 'none';
    // حفظ حالة الإغلاق في localStorage
    localStorage.setItem('desktopPopupClosed', 'true');
}
